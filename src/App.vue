        ...
        <ion-menu content-id="main-content" type="overlay">
            <ion-content>
                <ion-list id="inbox-list">
                    <ion-list-header>Olá, Leandro</ion-list-header>
                    <ion-note></ion-note>
                ...
                <ion-list id="labels-list">
                    <ion-item v-for="(label, index) in labels" lines="none" :key="index">
                        <ion-icon slot="start" :ios="label.icon" :md="label.icon"></ion-icon>
...
import { locationOutline, archiveOutline, bookmarkOutline, heartOutline, paperPlaneOutline,
         cardOutline,receiptOutline, newspaperOutline,helpCircleOutline, settingsOutline,
         shieldCheckmarkOutline, pizzaOutline, homeOutline } from "ionicons/icons";

export default defineComponent({
    name: "App",
    components: { IonApp, IonContent, IonIcon,IonItem,IonLabel,IonList,IonListHeader,
                  IonMenu,IonMenuToggle,IonNote,IonRouterOutlet,
                  IonSplitPane },
    setup() {
